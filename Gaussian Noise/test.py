...
class DAQ_main:
    ...
    def __init__(self, SampleN=1000, Rate=500000.0):
        self.Rate = Rate
        self.SampsN = SampleN
...
if __name__ == "__main__":
    DAQ = DAQ_main(SampleN=10000, Rate=10000)  # creat DAQ task
    # Laser369 = DLPro('COM1')
    ...
    def update():
        ...
        filename1 = './time_noise.txt'
        f = open(filename1,'a')
        amz = [str(i) for i in DAQ.xscale]
        f.write(str(amz))

        filename2 = './value_noise.txt'
        f = open(filename2,'a')
        amz = [str(i) for i in DAQ.data]
        f.write(str(amz))
        # f.close()
        # print type(DAQ.xscale[0])
        # with open(filename1, 'a+') as f:
        #     for i in DAQ.xscale
        #     f.write(str(i))
        # f.write('\n')    
        # filename2 = './value_data.txt'
